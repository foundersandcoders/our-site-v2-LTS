...
const Where = ({ color }) => (
  <CollapsableQuestion question="Where and when?" colour={color}>
    <p>
      The course takes place over four weeks, on
      <span className="fw5"> consecutive Tuesday evenings, </span> from{" "}
      <span className="fw5"> 18.30 to 20.30. </span>
      <br />
      <br />
      It's on-site here at Space4 in Finsbury Park.
    </p>
  </CollapsableQuestion>
)

const WhoElse = ({ color }) => (
  <CollapsableQuestion question="Who is the course for?" colour={color}>
    <p>
      The short course is aimed at people who are at the beginning of their
      coding journey - whether you've never written a line of code before, or
      ...
      <span className="fw5"> under-represented </span> in the tech industry.
    </p>
  </CollapsableQuestion>
)
...
const Learnings = ({ color }) => (
  ...
  >
    <p>
      Week 1: HTML and Toolkit
      <br />
      Week 2: CSS
      <br />
      Week 3: Beginning Javascript
      <br />
      Week 4: More Javascript and Codewars
      <br />
      <br />
      You'll learn the building blocks of web development in a{" "}
      <span className="fw5"> supportive </span> and{" "}
      <span className="fw5"> collaborative </span> environment.
    </p>
  </CollapsableQuestion>
)
...
//   >
//     <p>
//       We have a growing network of partners through which you can find
//       employment as a web developer. We also run the _Founders_ programme, with
//       a limited number of bursaries for graduates who want to build their own
//       companies, work with nonprofits, and mentor at our overseas campuses.
//     </p>
//   </CollapsableQuestion>
// )
//
