...
const ApplicationSteps = () => (
  <Fragment>
    ...
    >
      <span className="b">Before we can consider your application</span>, you
    ...
    <Step>
      <div className="pb3 pb0-l">
        ...
        and to create your one-page site on GitHub Pages.
      </div>
      <br />
      <div>
        <_SubHeading className="mb1">FreeCodeCamp</_SubHeading>
        Earn a minimum of 200 points on{" "}
    ...
    <Step step="03" colour="red" title="Submit an application">
      <p>
        Use{" "}
        <_ExternalLink href="https://prereq-check.herokuapp.com/">
          prereq-check
        </_ExternalLink>{" "}
        to ensure you are prepared to submit your application. Plan to spend
        about an hour completing the application form. If you submit your
        application before the deadline, we encourage you to keep learning and
        tidying up your website. We will evaluate your progress as of the date
        the window closes.
      </p>
    </Step>
    <Step
